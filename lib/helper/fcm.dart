...
class FCM {
  ...
  static var _serverKey =
      'AAAAnNzX_GY:APA91bH9djEIg15bw3X-7PLX5avwNuaaZz6Mp12awLazooVZARD2GGPyZ9KzK8AM1LPASiWJA4qcNQ_vce0AD5uIw8C2JZqz3dYZTQJtLpA1070i-dKDj_A0o2mmApwv9a2_hk8IdvQq';
  ...
  static Future<String> sendMessageSingle(
  ...
  static Future<String> sendMessageMulti(String notificationTitle,
      String notificationBody, List<String> tokens) async {
    var _headers = <String, String>{
      'Content-Type': 'application/json',
      'Authorization': 'key=$_serverKey',
    };
